...
class Robot:
    ...
    def __init__(self, leftCalibrate, rightCalibrate):
        ...
        self.__regulatorTurn = RegulatorP(0.05, 100)
        self.__regulatorFollow = RegulatorP(0.5, 300)
...
#            print("robot.follow - isTimeout")
            ...
            if forward:
                ...
                if speed > 0.3:
                    ...
                    speed = 0.3
                if distance < 0.2 and abs(angular) > 0.1:
                    # pokud jsme kousek od cile ale nejsme v priblizne spravnem smeru nepojedeme dopredu
                    speed = 0
            else:
