...
if __name__ == "__main__":
    ...
    robotLocalizeX = 0
    robotLocalizeY = 0
    commands = [Constants.FORWARD, Constants.FORWARD, Constants.LEFT, Constants.LEFT, Constants.FORWARD, Constants.FORWARD, Constants.RIGHT, Constants.RIGHT, Constants.FORWARD, Constants.FORWARD, Constants.LEFT, Constants.LEFT, Constants.FORWARD, Constants.FORWARD, Constants.RIGHT, Constants.RIGHT, Constants.FORWARD, Constants.FORWARD, Constants.FORWARD, Constants.RIGHT, Constants.FORWARD, Constants.FORWARD, Constants.FORWARD, Constants.RIGHT, Constants.FORWARD, Constants.FORWARD, Constants.FORWARD ]
    commandsIndex = -1
