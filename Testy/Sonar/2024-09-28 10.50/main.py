...
from microbit import i2c, pin0, pin8, pin12, pin14, pin15, button_a, sleep, display
    ...
    try:
        ...
        while not button_a.was_pressed():
            ...
            if ticks_diff(time, lastPrint) > 1_000:
                lastPrint = time
                print(robot.motionControl.__wheelLeft.__pwm, robot.motionControl.velocity.forward, robot.motionControl.__wheelLeft.getSpeed(Unit.MeterPerSecond), robot.getObstacleDistance(), robot.__sonar.lastDistance)
            sleep(1)
